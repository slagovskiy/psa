namespace Photoland.Forms.Admin
{
	partial class frmGoodTable
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmGoodTable));
			...
			this.Name = "frmGoodTable";
			this.Text = "frmGoodTable";
			this.Load += new System.EventHandler(this.frmGoodTable_Load);

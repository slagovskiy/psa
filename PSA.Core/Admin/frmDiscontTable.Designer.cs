namespace Photoland.Forms.Admin
{
	partial class frmDiscontTable
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmDiscontTable));
			...
			this.Name = "frmDiscontTable";
			this.Text = "frmDiscontTable";
			this.Load += new System.EventHandler(this.frmDiscontTable_Load);

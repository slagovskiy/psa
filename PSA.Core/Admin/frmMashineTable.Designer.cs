namespace Photoland.Forms.Admin
{
	partial class frmMashineTable
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmMashineTable));
			...
			this.Name = "frmMashineTable";
			this.Text = "frmMashineTable";
			this.Load += new System.EventHandler(this.frmMashineTable_Load);

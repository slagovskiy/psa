...
{
	public partial class frmOptionsPublic : Form
	{
		private DataTable tblRount = new DataTable("round");

		public frmOptionsPublic()
		{
			InitializeComponent();
		...
		private void frmOptionsPublic_Load(object sender, EventArgs e)
		{

...
{
	partial class frmQueryFrameParam2
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
            ...
            this.label4.Text = "Периметр является основным показателем, на основании которого будет расчитана сто" +
                "имость, остальные параметры просто для информации.";
            // 
            // label5
            // 

...
{
	partial class frmAccptanceTableImport
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmAccptanceTableImport));
			...
			this.checkAutoUpdate.Location = new System.Drawing.Point(389, 15);
			...
			this.checkAutoUpdate.Click += new System.EventHandler(this.checkAutoUpdate_CheckedChanged);
			// 
			// btnUpdate
			// 
			...
			this.btnUpdate.Location = new System.Drawing.Point(389, 40);
			...
			this.groupBox2.Location = new System.Drawing.Point(620, 523);
			...
			this.checkFilterInput.Enabled = false;
			...
			this.checkFilterInput.Size = new System.Drawing.Size(71, 19);
			this.checkFilterInput.TabIndex = 11;
			this.checkFilterInput.Text = "Экспорт";
			this.checkFilterInput.UseVisualStyleBackColor = true;
			this.checkFilterInput.Visible = false;
			this.checkFilterInput.Click += new System.EventHandler(this.checkFilterInput_CheckedChanged);
			// 
			// checkFilterOutput
			// 
			this.checkFilterOutput.AutoSize = true;
			this.checkFilterOutput.Enabled = false;
			this.checkFilterOutput.ForeColor = System.Drawing.SystemColors.ControlText;
			this.checkFilterOutput.Location = new System.Drawing.Point(128, 19);
			...
			this.checkFilterOutput.Text = "Импорт";
			this.checkFilterOutput.UseVisualStyleBackColor = true;
			this.checkFilterOutput.Visible = false;
			this.checkFilterOutput.Click += new System.EventHandler(this.checkFilterOutput_CheckedChanged);
			// 
			// txtDateBeginPr
			// 
			...
			this.txtDateBeginPr.Visible = false;
			// 
			// txtDateBegin
			// 
			...
			this.txtDateEndPr.Visible = false;
			// 
			// label3
			// 
			...
			this.btnFilterApply.Location = new System.Drawing.Point(389, 76);
			...
			this.GridOder.Size = new System.Drawing.Size(968, 505);
			this.GridOder.StyleInfo = resources.GetString("GridOder.StyleInfo");
			this.GridOder.TabIndex = 9;
			...
			this.label4.Text = "Иморт / Экспорт";
			// 
			// frmAccptanceTableImport
			// 
			...
			this.Name = "frmAccptanceTableImport";
			this.Text = "frmAccptanceTableImport";

...
{
	partial class frmVerificationDoc
	{
		/// <summary>
		...
		{
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmVerificationDoc));
            ...
            this.btnCloseInvent.Text = "Закрытие сверки";
            ...
            this.Name = "frmVerificationDoc";
            this.Load += new System.EventHandler(this.frmVerificationDoc_Load);
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.frmVerificationDoc_FormClosing);

...
{
    partial class frmOrderAskAction
    {
        /// <summary>
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmOrderAskAction));
			...
			this.btnMovePayment = new System.Windows.Forms.Button();
			...
			this.panel1.Size = new System.Drawing.Size(303, 448);
			...
			this.tableLayoutPanel1.Controls.Add(this.btnPrintCheck, 0, 0);
			...
			this.tableLayoutPanel1.Size = new System.Drawing.Size(303, 448);
			...
			this.button1.Text = "На выдаче (не обратимо)";
			...
			this.button5.Text = "Ожидание оплаты";
			...
			this.button4.Text = "Предварительный просмотр";
			...
			this.button3.Text = "В очередь на печать (оператору)";
			...
			this.button2.Text = "В очередь на обработку (дизайнеру)";
			this.button2.UseVisualStyleBackColor = true;
			this.button2.Click += new System.EventHandler(this.button2_Click);
			// 
			// btnPrintCheck
			// 
			this.btnPrintCheck.Dock = System.Windows.Forms.DockStyle.Fill;
			this.btnPrintCheck.Font = new System.Drawing.Font("Microsoft Sans Serif", 9.75F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(204)));
			this.btnPrintCheck.Location = new System.Drawing.Point(3, 3);
			this.btnPrintCheck.Name = "btnPrintCheck";
			this.btnPrintCheck.Size = new System.Drawing.Size(297, 44);
			this.btnPrintCheck.TabIndex = 0;
			this.btnPrintCheck.Text = "Печать чека";
			...
			this.label2.Text = "Назначить статус:";
			// 
			// tableLayoutPanel2
			// 
			this.tableLayoutPanel2.ColumnCount = 2;
			this.tableLayoutPanel2.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 81.48148F));
			...
			this.tableLayoutPanel2.Controls.Add(this.btnMovePayment, 0, 0);
			this.tableLayoutPanel2.Controls.Add(this.btnReLogin, 1, 0);
			...
			// btnMovePayment
			// 
			this.btnMovePayment.Dock = System.Windows.Forms.DockStyle.Fill;
			this.btnMovePayment.Font = new System.Drawing.Font("Microsoft Sans Serif", 11.25F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(204)));
			this.btnMovePayment.Location = new System.Drawing.Point(3, 3);
			this.btnMovePayment.Name = "btnMovePayment";
			this.btnMovePayment.Size = new System.Drawing.Size(236, 44);
			this.btnMovePayment.TabIndex = 0;
			this.btnMovePayment.Text = "Перенести оплату";
			this.btnMovePayment.UseVisualStyleBackColor = true;
			this.btnMovePayment.Click += new System.EventHandler(this.btnMovePayment_Click);
			// 
			// btnReLogin
			// 
			this.btnReLogin.Dock = System.Windows.Forms.DockStyle.Fill;
			this.btnReLogin.Image = ((System.Drawing.Image)(resources.GetObject("btnReLogin.Image")));
			this.btnReLogin.Location = new System.Drawing.Point(245, 3);
			this.btnReLogin.Name = "btnReLogin";
			this.btnReLogin.Size = new System.Drawing.Size(49, 44);
			this.btnReLogin.TabIndex = 1;
			...
			this.button6.Size = new System.Drawing.Size(297, 44);
			...
			this.Name = "frmOrderAskAction";
			this.Load += new System.EventHandler(this.frmOrderAskAction_Load);
		...
		private System.Windows.Forms.Button btnMovePayment;

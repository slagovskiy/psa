namespace Photoland.Forms.Admin
{
	partial class frmPostTable
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmPostTable));
			...
			this.Name = "frmPostTable";
			this.Text = "frmPostTable";
			this.Load += new System.EventHandler(this.frmPostTable_Load);

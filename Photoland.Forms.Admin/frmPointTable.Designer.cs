namespace Photoland.Forms.Admin
{
	partial class frmPointTable
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmPointTable));
			...
			this.groupBox2.Location = new System.Drawing.Point(505, 464);
			...
			this.Name = "frmPointTable";
			this.Text = "frmPointTable";
			this.Load += new System.EventHandler(this.frmPointTable_Load);

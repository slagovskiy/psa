...
{
	partial class frmMaterialTable
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmMaterialTable));
			...
			this.label1.Text = "Внимание! Данный справочник не должен редактироваться! Он импортируется из офиса." +
				"";
			// 
			// groupBox2
			// 
			...
			this.gridData.Location = new System.Drawing.Point(1, 1);
			...
			this.Name = "frmMaterialTable";
			this.Text = "frmMaterialTable";
			this.Load += new System.EventHandler(this.frmMaterialTable_Load);
